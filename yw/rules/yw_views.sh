...
#dir="/d/Study/Internship/WT_PaleoCar_2017/meteor_example/wt-prov-summer-2017/yw/facts/"

cd $FACTS_DIR

for file in `ls -a *.P` ;
do
xsb --quietload --noprompt --nofeedback --nobanner << END_XSB_STDIN > ${VIEWS_DIR}/${file}
['$FACTS_DIR/${file}'].
['$MODEL_DIR/${file}'].
