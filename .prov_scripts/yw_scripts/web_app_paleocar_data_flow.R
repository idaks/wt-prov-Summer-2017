...
#@in user_prediction_year @desc Prediction years for reconstruction of paleoclimate. 
...
#@out paleocar_model_log_file  @uri file:/.output/{session_id}{run_id}/paleocar_model_log.txt @desc a log file containing information about the execution of paleocar reconstruction.
    ...
    #@in prediction_year @as user_prediction_year @desc Prediction years for reconstruction of paleoclimate. 
    
    #@out coordinates  @desc Coordinates of location for reconstruction of paleoclimate. 
    #@out prediction_year @as prediction.year @desc Prediction years for reconstruction of paleoclimate. 
    #@end get_user_input 
    ...
    #@in prediction_year  @as prediction.year  @desc An optional integer vector of years for the reconstruction.
    ...
    #@in prediction.year @as prediction.year  @desc Prediction years for reconstruction of paleoclimate. 
